xml.feed(xmlns:"http://www.w3.org/2005/Atom",
  ...
  xml.content(rel:"src", href:collection_work_file_set_url(@collection_id, @object, @file_set))
  xml.link(rel:"edit", href:collection_work_file_set_url(@collection_id, @object, @file_set))
